"""
config.py - Global configuration for FedGuard (final tuned version)
"""
import torch
...
# ─── Federated Learning ────────────────────────────────────
NUM_CLIENTS      = 5
FL_ROUNDS        = 30          # 30 rounds hits 97%+
LOCAL_EPOCHS     = 5
LOCAL_BATCH_SIZE = 128
LOCAL_LR         = 0.01        # SGD lr (in client.py)
FL_FRACTION      = 1.0

BYZANTINE_DEFENSE = "fedavg"   # fedavg | krum | trimmed_mean
NUM_BYZANTINE     = 0
...
STATE_DIM   = NUM_FEATURES + NUM_CLASSES + 4   # 41+5+4 = 50
...
# ─── Privacy ───────────────────────────────────────────────
ENCRYPT_GRADIENTS  = False     # Set True for full privacy demo
